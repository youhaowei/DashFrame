...
export const HorizontalScroll: Story = {
  render: () => (
    <ScrollArea className="w-96 whitespace-nowrap rounded-md border bg-card">
      <div className="flex w-max gap-4 p-4">
        {Array.from({ length: 20 }, (_, i) => (
          <div
            key={i}
            className="h-20 w-40 shrink-0 rounded-md bg-accent flex items-center justify-center"
          >
            Card {i + 1}
          </div>
        ))}
