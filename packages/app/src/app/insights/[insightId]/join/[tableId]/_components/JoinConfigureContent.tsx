  ...
  useEffect(() => {
    ...
    const computeJoin = async () => {
      ...
      try {
        ...
        // Build the JOIN SQL — use explicit map so "outer" → "FULL OUTER JOIN"
        // (DuckDB rejects bare "OUTER JOIN"; must be "FULL OUTER JOIN").
        const joinTypeSQL = joinTypeToSQL(joinType);
