 ...
 * removal entirely (YW-72: "Move Notion data source integration off web tRPC").
 *
 ...
 *
 * When Notion is rewired (YW-72) onto the WyStack/server path, delete this.
 */
import type { ReactNode } from "react";

function notWired(): never {
  throw new Error(
    "Notion tRPC connector is not wired in v0.2 (tracked: YW-72). " +
