  ...
  describe("edge cases", () => {
    ...
    describe("special characters in identifiers", () => {
      it("should quote column names with spaces", async () => {
        ...
        expect(sql).toBe(
          'SELECT "first name", "last name" FROM "df_test_df_id"',
        );
      });
      ...
      it("should handle column names with numeric prefixes", async () => {
        ...
        expect(sql).toBe(
          'SELECT "123column", "99_percent" FROM "df_test_df_id"',
        );
      });
    ...
    describe("edge case value types", () => {
      ...
      it("should handle floating point numbers", async () => {
        ...
        expect(sql).toBe(
          'SELECT * FROM "df_test_df_id" WHERE "price" >= 19.99',
        );
      });
      ...
      it("should handle false boolean value", async () => {
        ...
        expect(sql).toBe(
          'SELECT * FROM "df_test_df_id" WHERE "active" = FALSE',
        );
      });
