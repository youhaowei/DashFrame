...
function createMockApi(options?: {
  ...
  return {
    ...
    marginLeft: passthrough("marginLeft"),
    marginBottom: passthrough("marginBottom"),
    xLabelArrow: passthrough("xLabelArrow"),
    yLabelArrow: passthrough("yLabelArrow"),
    xTicks: passthrough("xTicks"),
    yTicks: passthrough("yTicks"),
    xTickSize: passthrough("xTickSize"),
    yTickSize: passthrough("yTickSize"),
    xZero: passthrough("xZero"),
    yZero: passthrough("yZero"),
