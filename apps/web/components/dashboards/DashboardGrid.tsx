...
export function DashboardGrid({ dashboard, isEditable }: DashboardGridProps) {
    ...
    return (
        <ResponsiveGridLayout
            ...
            resizeHandle={
                isEditable ? (
                    <div className="absolute -bottom-2 -right-2 z-50 flex h-6 w-6 cursor-se-resize items-center justify-center text-muted-foreground/40 transition-colors hover:text-muted-foreground">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
