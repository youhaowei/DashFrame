...
export function Navigation() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "bg-background/95/80 border-border/60 supports-backdrop-filter:bg-background/80 sticky top-0 hidden h-screen flex-col overflow-y-auto border-r backdrop-blur transition-all duration-300 lg:flex",
          sidebarWidth,
        )}
      >
        <SidebarContent
