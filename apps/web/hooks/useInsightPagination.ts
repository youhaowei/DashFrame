/* eslint-disable sonarjs/cognitive-complexity -- SQL building logic is inherently complex */
...
export function useInsightPagination({
  ...
  const buildSQL = useCallback(
    async (
      ...
      // TODO(insight-query): Implement full insight query mode with aggregations, filters, sorts
