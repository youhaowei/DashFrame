...
import { BarChart3, Table as TableIcon, List, LayoutGrid, Sun, Moon, Toggle, Card } from "@dashframe/ui";
    ...
    return (
        <div className="container mx-auto p-8 space-y-8">
            ...
            <div className="space-y-2">
                <h2 className="text-xl font-semibold">Default Variant - Default Size</h2>
                <p className="text-muted-foreground">Standard size with filled background style</p>
                <Card className="p-4">
                    <Toggle
                        variant="default"
                        size="default"
            ...
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Small size with filled background style</p>
                <Card className="p-4">
                    <Toggle
                        variant="default"
                        size="sm"
            ...
            <div className="space-y-2">
                <h2 className="text-xl font-semibold">Outline Variant - Default Size</h2>
                <p className="text-muted-foreground">Standard size with outline style</p>
                <Card className="p-4">
                    <Toggle
                        variant="outline"
                        size="default"
            ...
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Small size with outline style (NEW)</p>
                <Card className="p-4">
                    <Toggle
                        variant="outline"
                        size="sm"
            ...
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Example with small size theme toggle</p>
                <Card className="p-4">
                    <Toggle
                        variant="outline"
                        size="sm"
            ...
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Testing disabled state with small size</p>
                <Card className="p-4">
                    <Toggle
                        variant="outline"
                        size="sm"
